...
这是图书管理系统的 React + TypeScript + Vite 前端。页面采用 Apple 风格的 Liquid Glass 视觉语言：系统字体、液态磨砂导航、冷白浅蓝光场、蓝色主操作、鼠标响应光晕、滚动进度和移动端抽屉导航。登录页展示 `202314109方昕哲制作 · 20260831` 的淡色斜向制作水印；登录后页面会在内容背景显示当前账号的低透明度斜向水印，打印凭单时自动隐藏。
